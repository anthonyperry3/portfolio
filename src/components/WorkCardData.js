...
const ProjectCardData = [
  {
    ...
    text: "Created a dynamic background image with CSS, while also using animation.",
    view: "https://anthonyperry3.github.io/css-animated-bg/",
    source: "https://github.com/anthonyperry3/css-animated-bg",
  },
  {
    imgsrc: pro2,
